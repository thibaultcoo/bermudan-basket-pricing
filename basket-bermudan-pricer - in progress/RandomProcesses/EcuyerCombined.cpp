...
EcuyerCombined::EcuyerCombined() : Generator1(10, 40014, 0, 2147483563), Generator2(15, 40692, 0, 2147483399) { }

double EcuyerCombined::Generate()
{
	myLong current_number1 = Generator1.Generate() * Generator1.get_Modulus();
	myLong current_number2 = Generator2.Generate() * Generator2.get_Modulus();
