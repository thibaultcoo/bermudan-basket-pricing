...
class Priceable {
    public:
        ...
        std::pair<double, double> getPricesQuasiMC() const { return pricesQuasiMC; }
        ...
        std::pair<double, double> getVariancesQuasiMC() const { return variancesQuasiMC; }
        ...
        std::pair<std::vector<double>, std::vector<double>> getConfIntervalQuasiMC() const { return confIntervalQuasiMC; }
    ...
    private:
        ...
        std::pair<double, double> pricesRaw, pricesAntithetic, pricesControlVar, pricesQuasiMC;
        std::string optionFeaturesName;

        // Variables to store variances and confidence intervals for each price type
        std::pair<double, double> variancesRaw, variancesAntithetic, variancesControlVar, variancesQuasiMC;
        std::pair<std::vector<double>, std::vector<double>> confIntervalRaw, confIntervalAntithetic, confIntervalControlVar, confIntervalQuasiMC;
